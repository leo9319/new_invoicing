                    ...
                    {{ Form::open(['route'=>'sales.store', 'autocomplete'=>'off']) }}
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12">
                                    <div class="position-relative form-group">
                                        ...
                                        {{ Form::select('product_id', $products->pluck('name', 'id'), null, ['placeholder'=>'Product Name', 'class'=>"form-control", 'v-model'=>'product_id', '@change' => 'onProductChange', 'required'=>'required']) }}
                                    </div>
                                </div> 
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                    {{ Form::label('mrp', 'MRP') }}
                                    {{ Form::text('mrp', null, ['placeholder'=>'MRP', 'class'=>"form-control", 'required'=>'required']) }}
                                </div>
                            </div> 
